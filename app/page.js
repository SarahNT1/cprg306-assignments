...
export default function Home() {
  return (
    <main className="bg-black min-h-screen flex flex-col text-center">
      ...
      <div>
        <Link href="/week-7" className="text-gray-100 text-xl hover:underline hover:text-green-500">
          Week 7 Assignment
        </Link>
      </div>
      <div>
        <Link href="/week-8" className="text-gray-100 text-xl hover:underline hover:text-green-500">
          Week 8 Assignment
        </Link>
      </div>
    </main>
